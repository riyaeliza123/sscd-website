...
# yolo_anchors = np.array([14,34, 12,42, 16,45, 20,37, 22,48, 18,61, 30,43, 27,61, 38,61], np.float32).reshape(-1,2)/[3904, 64]
# yolo_anchors = np.array([5,5,59,3,9,45,59,9,61,19,21,55,44,31,40,54,63,37]).reshape(-1,2)/576
...
def yolo_nms(outputs, anchors, masks, classes, yolo_max_boxes,
             yolo_score_threshold, yolo_iou_threshold):
    # boxes, conf, type
    b, c, t = [], [], []
...
def YoloV3(width=None, height=None, channels=3, anchors=yolo_anchors,
           ...
           yolo_max_boxes = 100, yolo_score_threshold=0.5,
...
def YoloV3Tiny(width=None, height=None, channels=3, anchors=yolo_tiny_anchors,
...
def YoloLoss(anchors, classes=80, ignore_thresh=0.5):
    def yolo_loss(y_true, y_pred):
        ...
        # y_true: (batch_size, grid, grid, ancnhors, (x1, y1, x2, y2, obj, cls))
        ...
        # obj_loss = conf_focal * binary_crossentropy(true_obj, pred_obj)
